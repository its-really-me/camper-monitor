...
| FE-4 | German language option | Add German language as an option to be selected in configuration script and implemented by i18m concept. Language option only applies to UI, not to the scripts. |
